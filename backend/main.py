...
import gee_auth
import indices
from schemas import CalculateRequest, CrossSectionRequest
...
async def calculate(req: CalculateRequest):
    ...
    Uses the most recent Sentinel-2 scene available with <=5% cloud cover.
...
@app.post("/api/cross-section", tags=["indices"])
